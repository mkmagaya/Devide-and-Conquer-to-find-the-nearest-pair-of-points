...
def nearestPoint(P, Q, n):
	...
	'''
	dl = nearestPoint(Pl, Q, mid)
	dr = nearestPoint(Pr, Q, n - mid)
	...
	min_a = min(d, stripNearest(stripP, len(stripP), d))
	min_b = min(d, stripNearest(stripQ, len(stripQ), d))
...
This method mainly uses nearestPoint()
'''
def closest(P, n):
	...
	'''
	Use recursive function nearestPoint()
	to find the smallest distance
	'''
	return nearestPoint(P, Q, n)

# Driver code
P = [Point(4, 3), Point(12, 30),
	Point(24, 35), Point(15, 7),
	Point(17, 10), Point(3, 6)]
n = len(P)
print("The smallest distance is",
				closest(P, n))

# Contributed by Makomborero Magaya (@mkmagaya)
